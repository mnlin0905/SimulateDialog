package com.knowledge.mnlin.test_dy_compiler;
...
public class SimulateLoadProcess {
    public static void main(String[] args) {
        ...
        try {
            childLoader.loadClass("com.knowledge.mnlin.test_dy_compiler.TestOneOne");
            parentLoader.loadClass("com.knowledge.mnlin.test_dy_compiler.TestOneOne");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
        try {
            Class a = Class.forName("com.knowledge.mnlin.test_dy_compiler.TestOne",true,childLoader);
            Class b = Class.forName("com.knowledge.mnlin.test_dy_compiler.TestOne",true,parentLoader);
...
class MyClassLoader extends ClassLoader {
    ...
    protected Class<?> findClass(String s) throws ClassNotFoundException {
        try {
            ...
            return defineClass("com.knowledge.mnlin.test_dy_compiler.TestOne", bytes, 0, bytes.length);
        } catch (IOException e) {
            e.printStackTrace();
